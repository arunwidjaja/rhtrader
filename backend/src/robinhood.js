...
exports.RobinHoodCryptoTrader = void 0;
...
var RobinHoodCryptoTrader = /** @class */ (function () {
    ...
    RobinHoodCryptoTrader.prototype.get_timestamp = function () {
    ...
    RobinHoodCryptoTrader.prototype.get_query_params = function (key, args) {
        var params = [];
        if (!args) {
            return "";
        }
    ...
    RobinHoodCryptoTrader.prototype.get_authorization_header = function (method, path, body, timestamp) {
    ...
    RobinHoodCryptoTrader.prototype.make_api_request = function (method_1, path_1) {
    ...
    RobinHoodCryptoTrader.prototype.get_account = function () {
     ...
     */
    RobinHoodCryptoTrader.prototype.get_holdings = function (asset_codes) {
    ...
    RobinHoodCryptoTrader.prototype.get_trading_pairs = function (symbols) {
    ...
    RobinHoodCryptoTrader.prototype.get_best_bid_ask = function (symbols) {
        var query_params = this.get_query_params("symbol", symbols);
        var path = ("/api/v1/crypto/trading/best_bid_ask/" + { query_params: query_params });
        return this.make_api_request("GET", path);
    };
    RobinHoodCryptoTrader.prototype.get_estimated_price = function (symbol, side, quanitity) {
        var path = ("/api/v1/crypto/marketdata/estimated_price/?symbol=" + symbol + "&side=" + side + "&quantity=" + quanitity);
        return this.make_api_request("GET", path);
    };
    RobinHoodCryptoTrader.prototype.place_order = function (client_order_id, side, order_type, symbol, order_config) {
        var _a;
    ...
    RobinHoodCryptoTrader.prototype.cancel_order = function (order_id) {
        var path = ("/api/v1/crypto/trading/orders/" + order_id + "/cancel/");
        return this.make_api_request("POST", path);
    };
    RobinHoodCryptoTrader.prototype.get_order = function (order_id) {
        var path = ("/api/v1/crypto/trading/orders/" + order_id + "/");
        return this.make_api_request("GET", path);
    };
    RobinHoodCryptoTrader.prototype.get_orders = function () {
        var path = "/api/v1/crypto/trading/orders/";
        return this.make_api_request("GET", path);
    };
    return RobinHoodCryptoTrader;
}());
exports.RobinHoodCryptoTrader = RobinHoodCryptoTrader;
